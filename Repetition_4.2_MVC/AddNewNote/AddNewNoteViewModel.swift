...
protocol AddNewNoteViewModelProtocol {
    func addNewNote() -> Notebook
...
class AddNewNoteViewModel: AddNewNoteViewModelProtocol {
    private let mainLabel = ""
    private let secondLabel = ""
    private let text = ""
    
    func addNewNote() -> Notebook {
        Notebook(mainLabel: mainLabel, secondLabel: secondLabel, text: text)
    }
